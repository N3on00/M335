...
describe('native shell project contracts', () => {
  it('contains Android shell with expected package and permissions', () => {
    ...
    expect(fileExists('../../android/app/src/main/java/ch/spotonsight/mobile/MainActivity.java')).toBe(true)
    ...
    const activity = readText('../../android/app/src/main/java/ch/spotonsight/mobile/MainActivity.java')
